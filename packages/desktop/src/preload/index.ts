...
export type ElectronAPI = {
    ...
    syncNowPlaying: (info: { trackId: string; name: string; artist: string; artUrl: string | null; singerConfigs?: any[]; stageTheme?: string | null; turnId?: string } | null) => Promise<void>
    ...
    createAward: (input: { title: string; description: string; subjectType: 'performance' | 'singer' | 'group'; iconId: string | null; iconDataUrl: string | null; createdByGuestId: string }) => Promise<{ id?: string; error?: string }>
    updateAward: (awardId: string, fields: { title?: string; description?: string; iconId?: string | null; iconDataUrl?: string | null }) => Promise<{ error?: string }>
    ...
    setAwardAdjustments: (awardId: string, adjustments: Record<string, number>) => Promise<{ error?: string }>
...
const api: ElectronAPI = {
    ...
    deleteSession: (sessionId) => ipcRenderer.invoke('karaoke:delete-session', sessionId),
