...
// Unknown / not-yet-implemented themes (psychedelic, zen, space, steampunk,
// retrowave) fall back to neo-brutal so the app keeps rendering instead of
// crashing — same fallback behavior as resolveMobileTheme().
