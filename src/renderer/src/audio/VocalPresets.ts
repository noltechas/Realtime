...
export const BUILT_IN_PRESETS: VocalPreset[] = [
    ...
    // ===== HIP-HOP =====
    {
        ...
        name: 'T-Pain',
        category: 'hip-hop',
        description: 'Heavy autotune pioneer, bright forward presence, shimmering doubled vocal, tight room',
        ...
        effects: {
            ...
            eq: { enabled: true, lowGain: 3, midGain: 4, highGain: 6 },
            chorus: { enabled: true, rate: 1.4, depth: 0.18, mix: 32 },
            delay: { enabled: true, time: 220, feedback: 18, mix: 12 },
    ...
    },
    {
        ...
        name: 'Travis Scott',
        category: 'hip-hop',
        description: 'Heavy autotune, dark cavernous reverb, doubled vocal, gritty slapback trails',
        ...
        effects: {
            ...
            eq: { enabled: true, lowGain: 2, midGain: 1, highGain: -2 },
            chorus: { enabled: true, rate: 0.8, depth: 0.15, mix: 22 },
            delay: { enabled: true, time: 350, feedback: 40, mix: 28 },
    ...
    },
    {
        ...
        category: 'hip-hop',
        description: 'Full mechanical autotune lock, cold vocoder-width, cavernous hall with massive pre-delay',
        artistId: '5K4W6rqBFWDnAN6FQUkS6x',
        effects: {
            pitchCorrection: { enabled: true, strength: 100 },
            compressor: { enabled: true, threshold: -18, ratio: 7, attack: 0.003, release: 0.12 },
            eq: { enabled: true, lowGain: -2, midGain: -1, highGain: 4 },
            chorus: { enabled: true, rate: 0.5, depth: 0.12, mix: 16 },
            delay: { enabled: true, time: 280, feedback: 20, mix: 8 },
    ...
    },
    {
        ...
        name: 'Kendrick Lamar',
        category: 'hip-hop',
        description: 'Extra-crisp and dry, sharp mids/highs, punchy compression, near-zero reverb',
        artistId: '2YZyLoL8N0Wb9xBt1NhZWg',
        effects: {
            pitchCorrection: { enabled: false, strength: 0 },
            compressor: { enabled: true, threshold: -16, ratio: 6, attack: 0.003, release: 0.08 },
            eq: { enabled: true, lowGain: -3, midGain: 7, highGain: 8 },
            chorus: { enabled: false, rate: 1.5, depth: 0.2, mix: 0 },
            delay: { enabled: false, time: 250, feedback: 20, mix: 0 },
    ...
    },
    {
        ...
        name: 'Playboi Carti',
        category: 'hip-hop',
        description: 'Aggressive squealing autotune, heavy distortion, doubled ad-libs, chaotic delays',
        artistId: '699OTQXzgjhIYAHMy9RyPD',
        effects: {
            pitchCorrection: { enabled: true, strength: 95 },
            compressor: { enabled: true, threshold: -22, ratio: 7, attack: 0.002, release: 0.06 },
            eq: { enabled: true, lowGain: -3, midGain: 0, highGain: 9 },
            chorus: { enabled: true, rate: 1.2, depth: 0.15, mix: 20 },
    ...
    },
    {
        ...
        name: 'MF DOOM',
        category: 'hip-hop',
        description: 'Lo-fi, gritty, muffled highs, heavy saturation, minimal processing',
        artistId: '2pAWfrd7WFF3XhVt9GoKjQ',
        effects: {
            pitchCorrection: { enabled: false, strength: 0 },
            compressor: { enabled: true, threshold: -12, ratio: 3, attack: 0.01, release: 0.2 },
            eq: { enabled: true, lowGain: 3, midGain: 2, highGain: -8 },
            chorus: { enabled: false, rate: 1.5, depth: 0.2, mix: 0 },
            delay: { enabled: false, time: 250, feedback: 20, mix: 0 },
...

    {
        ...
        name: 'Drake',
        category: 'hip-hop',
        description: 'Smooth melodic rap, warm R&B tone, subtle doubling, polished reverb, tape warmth',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 0.6, depth: 0.10, mix: 14 },
    ...
    },
    {
        ...
        name: 'Kanye West (Rap)',
        category: 'hip-hop',
        description: 'Punchy Graduation-era rap, forward mids, crisp presence, tape warmth, subtle slapback',
        artistId: '5K4W6rqBFWDnAN6FQUkS6x',
        effects: {
            pitchCorrection: { enabled: false, strength: 0 },
            compressor: { enabled: true, threshold: -18, ratio: 6, attack: 0.003, release: 0.08 },
            eq: { enabled: true, lowGain: -1, midGain: 6, highGain: 6 },
            chorus: { enabled: false, rate: 1.5, depth: 0.2, mix: 0 },
    ...
    },
    {
        ...
        name: 'A$AP Rocky',
        category: 'hip-hop',
        description: 'Cloud rap: smooth flow with wide doubling, dreamy long reverb, laid-back compression',
        artistId: '13ubrt8QOOCPljQ2FL1Kca',
        effects: {
            pitchCorrection: { enabled: true, strength: 20 },
            compressor: { enabled: true, threshold: -18, ratio: 4, attack: 0.005, release: 0.1 },
            eq: { enabled: true, lowGain: 1, midGain: 2, highGain: 4 },
            chorus: { enabled: true, rate: 0.5, depth: 0.18, mix: 20 },
            delay: { enabled: true, time: 280, feedback: 25, mix: 18 },
    ...
    },
    {
        ...
        name: 'J. Cole',
        category: 'hip-hop',
        description: 'Clean lyrical delivery, natural balanced tone, light tape warmth, minimal processing',
        artistId: '6l3HvQ5sa6mXTsMTB19rO5',
        effects: {
            pitchCorrection: { enabled: false, strength: 0 },
            compressor: { enabled: true, threshold: -16, ratio: 4, attack: 0.004, release: 0.1 },
            eq: { enabled: true, lowGain: -2, midGain: 5, highGain: 5 },
            chorus: { enabled: false, rate: 1.5, depth: 0.2, mix: 0 },
            delay: { enabled: false, time: 250, feedback: 20, mix: 0 },
    ...
    },
    {
        ...
        name: 'Bad Bunny',
        category: 'hip-hop',
        description: 'Reggaeton vocal: warm autotune, punchy low-end, wide doubling, rhythmic delay',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 0.8, depth: 0.14, mix: 18 },
    ...
    },
    {
        ...
        name: 'Future',
        category: 'hip-hop',
        description: 'Heavy melodic autotune, dark scooped mids, doubled mumble tone, subtle low grit',
        artistId: '1RyvyyTE3xzB2ZywiAwp0i',
        effects: {
            pitchCorrection: { enabled: true, strength: 90 },
            compressor: { enabled: true, threshold: -20, ratio: 5, attack: 0.003, release: 0.08 },
            eq: { enabled: true, lowGain: 4, midGain: -1, highGain: 3 },
            chorus: { enabled: true, rate: 0.6, depth: 0.14, mix: 20 },
    ...
    },
    {
        ...
        name: 'Lil Uzi Vert',
        category: 'hip-hop',
        description: 'Energetic melodic rap, bright shimmering autotune, doubled highs, tight room',
        artistId: '4O15NlyKLIASxsJ0PrXPfz',
        effects: {
            pitchCorrection: { enabled: true, strength: 90 },
            compressor: { enabled: true, threshold: -20, ratio: 6, attack: 0.002, release: 0.06 },
            eq: { enabled: true, lowGain: -1, midGain: 0, highGain: 9 },
            chorus: { enabled: true, rate: 1.5, depth: 0.16, mix: 22 },
    ...
    },
    {
        ...
        name: 'Pop Smoke',
        category: 'hip-hop',
        description: 'Deep Brooklyn drill voice, heavy sub, muffled highs, heavy gravelly saturation',
        artistId: '0eDvMgVFoNV3TpwtrVCoTj',
        effects: {
            pitchCorrection: { enabled: false, strength: 0 },
            compressor: { enabled: true, threshold: -18, ratio: 8, attack: 0.003, release: 0.08 },
            eq: { enabled: true, lowGain: 7, midGain: 2, highGain: -4 },
            chorus: { enabled: false, rate: 1.5, depth: 0.2, mix: 0 },
    ...
    // ===== R&B =====
    {
        ...
        name: 'Frank Ocean',
        category: 'r&b',
        description: 'Subtle, clean, intimate with slow whisper-doubling, airy delay, light reverb',
        ...
        effects: {
            ...
            eq: { enabled: true, lowGain: -2, midGain: 1, highGain: 4 },
            chorus: { enabled: true, rate: 0.4, depth: 0.08, mix: 12 },
    ...
    },
    {
        ...
        name: 'The Weeknd',
        category: 'r&b',
        description: 'Polished 80s retro R&B, heavy retro-chorus shimmer, bright highs, medium hall',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 0.5, depth: 0.18, mix: 28 },
    ...
    },
    {
        ...
        name: 'SZA',
        category: 'r&b',
        description: 'Breathy, warm, wide chorus width, bright silky highs, lush reverb',
        artistId: '7tYKF4w9nC0nq9CsPZTHyP',
        effects: {
            pitchCorrection: { enabled: true, strength: 20 },
            compressor: { enabled: true, threshold: -18, ratio: 3.5, attack: 0.008, release: 0.15 },
            eq: { enabled: true, lowGain: 2, midGain: 2, highGain: 6 },
            chorus: { enabled: true, rate: 0.7, depth: 0.14, mix: 20 },
            delay: { enabled: false, time: 250, feedback: 20, mix: 0 },
...

    {
        ...
        name: 'Ne-Yo',
        category: 'r&b',
        description: 'Smooth R&B crooner, clean polished tone, subtle doubling, warm reverb, silky highs',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 0.5, depth: 0.10, mix: 14 },
    ...
    // ===== POP =====
    {
        ...
        name: 'Billie Eilish',
        category: 'pop',
        description: 'Whispery, close-mic, near-dry room, delicate double, featherlight compression',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 0.4, depth: 0.08, mix: 10 },
            delay: { enabled: true, time: 300, feedback: 12, mix: 4 },
    ...
    },
    {
        ...
        name: 'Lady Gaga',
        category: 'pop',
        description: 'Powerful pop vocal, wide doubling, bright EQ, polished compression, hall reverb',
        ...
        effects: {
            ...
            eq: { enabled: true, lowGain: 0, midGain: 5, highGain: 6 },
            chorus: { enabled: true, rate: 0.5, depth: 0.12, mix: 18 },
...

    {
        ...
        name: 'Rihanna',
        category: 'pop',
        description: 'Bold pop vocal, forward presence, subtle doubling, punchy compression, medium reverb',
        artistId: '5pKCCKE2ajJHZ9KAiaK11H',
        effects: {
            pitchCorrection: { enabled: true, strength: 30 },
            compressor: { enabled: true, threshold: -20, ratio: 5, attack: 0.004, release: 0.1 },
            eq: { enabled: true, lowGain: 0, midGain: 4, highGain: 6 },
            chorus: { enabled: true, rate: 0.6, depth: 0.10, mix: 14 },
            delay: { enabled: true, time: 180, feedback: 15, mix: 8 },
            reverb: { enabled: true, decay: 2.0, preDelay: 15, mix: 24 },
            distortion: { enabled: false, drive: 0, mix: 0 },
    ...
    },
    {
        ...
        name: 'Dua Lipa',
        category: 'pop',
        description: 'Modern disco-pop, tight compression, heavy retro chorus, bright and punchy',
        artistId: '6M2wZ9GZgrQXHCFfjv46we',
        effects: {
            pitchCorrection: { enabled: true, strength: 30 },
            compressor: { enabled: true, threshold: -20, ratio: 5, attack: 0.004, release: 0.08 },
            eq: { enabled: true, lowGain: 1, midGain: 3, highGain: 5 },
            chorus: { enabled: true, rate: 0.5, depth: 0.15, mix: 22 },
            delay: { enabled: true, time: 160, feedback: 15, mix: 8 },
    ...
    },
    {
        ...
        name: 'Katy Perry',
        category: 'pop',
        description: 'Big pop vocal, bright and wide, polished hall reverb, radio-ready doubling',
        artistId: '6jJ0s89eD6GaHleKKya26X',
        effects: {
            pitchCorrection: { enabled: true, strength: 35 },
            compressor: { enabled: true, threshold: -20, ratio: 5, attack: 0.005, release: 0.1 },
            eq: { enabled: true, lowGain: -1, midGain: 4, highGain: 7 },
            chorus: { enabled: true, rate: 0.6, depth: 0.15, mix: 18 },
    ...
    },
    {
        ...
        name: 'Nicki Minaj',
        category: 'pop',
        description: 'Versatile pop-rap, sharp forward presence, crisp highs, subtle double, tight dynamics',
        artistId: '0hCNtLu0JehylgoiP8L4Gh',
        effects: {
            pitchCorrection: { enabled: true, strength: 25 },
            compressor: { enabled: true, threshold: -18, ratio: 5, attack: 0.003, release: 0.08 },
            eq: { enabled: true, lowGain: -1, midGain: 5, highGain: 7 },
            chorus: { enabled: true, rate: 0.7, depth: 0.12, mix: 12 },
            delay: { enabled: true, time: 160, feedback: 15, mix: 8 },
    ...
    },
    {
        ...
        name: 'Pitbull',
        category: 'pop',
        description: 'Party anthem vocal, wide doubling, big room reverb, bright and energetic',
        artistId: '0TnOYISbd1XYRBk9myaseg',
        effects: {
            pitchCorrection: { enabled: true, strength: 20 },
            compressor: { enabled: true, threshold: -20, ratio: 5, attack: 0.003, release: 0.08 },
            eq: { enabled: true, lowGain: 1, midGain: 4, highGain: 6 },
            chorus: { enabled: true, rate: 0.7, depth: 0.12, mix: 16 },
    ...
    // ===== ROCK =====
    {
        ...
        name: 'Bon Iver',
        category: 'rock',
        description: 'Heavily layered ethereal harmonies, scooped mids, epic cathedral reverb',
        ...
        effects: {
            ...
            eq: { enabled: true, lowGain: 1, midGain: -3, highGain: 4 },
            chorus: { enabled: true, rate: 0.5, depth: 0.28, mix: 38 },
    ...
    },
    {
        ...
        name: 'Tame Impala',
        category: 'rock',
        description: 'Psychedelic, swirling deep modulation, tape grit, analog delay, cavernous reverb',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 0.9, depth: 0.30, mix: 32 },
    ...
    },
    {
        ...
        name: 'The Killers',
        category: 'rock',
        description: 'Anthemic rock, punchy forward mids, bright and present, arena reverb',
        artistId: '0C0XlULifJtAgn6ZNCW2eu',
        effects: {
            pitchCorrection: { enabled: true, strength: 10 },
            compressor: { enabled: true, threshold: -18, ratio: 5, attack: 0.005, release: 0.1 },
            eq: { enabled: true, lowGain: -1, midGain: 6, highGain: 4 },
    ...
    },
    {
        ...
        name: 'Imogen Heap',
        category: 'electronic',
        description: 'Crystalline autotune, dense harmonizer, long echoes, ethereal near-infinite reverb',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 0.5, depth: 0.2, mix: 42 },
