...
export const BUILT_IN_PRESETS: VocalPreset[] = [
    ...
    // ===== HIP-HOP =====
    {
        ...
        name: 'T-Pain',
        category: 'hip-hop',
        description: 'Hard autotune lock, bright ringing presence, tight room, subtle slapback',
        ...
        effects: {
            ...
            eq: { enabled: true, lowGain: 2, midGain: 4, highGain: 7 },
            chorus: { enabled: false, rate: 1.4, depth: 0.18, mix: 0 },
    ...
    },
    {
        ...
        effects: {
            ...
            chorus: { enabled: false, rate: 0.8, depth: 0.15, mix: 0 },
    ...
    },
    {
        ...
        category: 'hip-hop',
        description: 'Full mechanical autotune lock, cold neutral EQ, cavernous hall with massive pre-delay',
        ...
        effects: {
            ...
            chorus: { enabled: false, rate: 0.5, depth: 0.12, mix: 0 },
    ...
    },
    {
        ...
        name: 'Playboi Carti',
        category: 'hip-hop',
        description: 'Aggressive squealing autotune, heavy distortion, chaotic short delays',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 1.2, depth: 0.12, mix: 10 },
    ...
    },
    {
        ...
        name: 'Lil Uzi Vert',
        category: 'hip-hop',
        description: 'Energetic melodic rap, bright shimmering autotune, tight room',
        ...
        effects: {
            ...
            chorus: { enabled: true, rate: 1.5, depth: 0.12, mix: 12 },
